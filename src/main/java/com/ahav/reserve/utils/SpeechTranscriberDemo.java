...
public class SpeechTranscriberDemo {
    ...
    public void SpeechTranscriberDemo1(String appKey, String token) {
        this.appKey = appKey;
        ...
        SpeechTranscriberListener listener = new SpeechTranscriberListener() {
            ...
            public void onSentenceEnd(SpeechTranscriberResponse response) {
                System.out.println(/*"name: " + response.getName() +
                        ...
                        ", result: " + response.getTransSentenceText() +
                        // 当前已处理的音频时长，单位是毫秒
                        ", time: " + response.getTransSentenceTime()*/"result: " + response.getTransSentenceText());
            }
            // 识别完毕
            @Override
    ...
    public void main() {
        ...
        String appKey = "xeTF1s8KHEaFsgO6";
        String token = "8981b8fcee2b4911be90606dd04bcdba";

        SpeechTranscriberDemo1(appKey, token);
        InputStream ins = SpeechTranscriberDemo.class.getResourceAsStream("/女声.pcm");
        if (null == ins) {
